	...
	Role role)
{
	...
	switch (option)
	{
		...
		case 3:
		{
			runAddToMenuOption(failCodes);
			break;
		}
		case 4:
		{
			runRemoveFromMenuOption(failCodes);
			break;
		}
		case 5:
		{
		...
		case 6:
		{
			runShowOrdersWithCountOption();
			break;
		}
		case 7:
		{
			runPlaceOrderOption(failCodes);
			break;
		}
		case 8:
		{
			runCancelOrderOption(failCodes);
			break;
		}
		case 9:
		{
			runShowInventoryOption();
			break;
		}
		case 10:
		{
			runAddToInventoryOption(failCodes);
			break;
		}
		case 11:
		{
			runRemoveFromInventoryOption(failCodes);
			break;
		}
		case 12:
		{
			runCurrentRevenueOption();
			break;
		}
		case 13:
		{
		...
		case 14:
		{
			runRevenueFromDateToTodayOption(failCodes);
			break;
		}
	}
